...
class ReportController extends Controller
{
    public function index(Request $request)
    {
        ...
        $stats = [
            ...
            'net_income' => $monthlyOfferingsAmt - $monthlyExpensesAmt,
        ...
        for ($i = 5; $i >= 0; $i--) {
            ...
            $income = $incomeTrends->firstWhere('month', $monthKey);
        ...
        return view('reports.index', compact('stats', 'membersByDept', 'offeringsByCat', 'expensesByCat', 'labels', 'incomeData', 'expenseData', 'selectedMonth'));
    }
    ...
    public function general()
    {
        ...
        $financials = [
            'total_income' => Offering::sum('amount'),
